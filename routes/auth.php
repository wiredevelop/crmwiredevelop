...
Route::middleware('guest')->group(function () {
    ...
    // WEB AUTHN - LOGIN (userless)
    Route::post('/webauthn/login/options', [PasskeyLoginController::class, 'options'])
        ->withoutMiddleware(VerifyCsrfToken::class);

    Route::post('/webauthn/login', [PasskeyLoginController::class, 'login'])
        ->withoutMiddleware(VerifyCsrfToken::class);
...
Route::middleware('auth')->group(function () {
    ...
    // WEB AUTHN - REGISTO
    Route::post('/webauthn/register/options', [PasskeyRegisterController::class, 'options'])
        ->withoutMiddleware(VerifyCsrfToken::class);

    Route::post('/webauthn/register', [PasskeyRegisterController::class, 'register'])
        ->withoutMiddleware(VerifyCsrfToken::class);
