...
class DashboardApiController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        $stats = [
            ...
            'active_projects' => Project::where('status', '!=', 'concluido')->where('status', '!=', 'cancelado')->count(),
            ...
            'paid_this_month' => Invoice::whereMonth('paid_at', now()->month)->whereYear('paid_at', now()->year)->sum('total'),
        ...
        return $this->success([
            ...
            'recent_invoices' => Invoice::with(['client', 'project'])->latest()->take(5)->get(),
            'pending_invoices' => Invoice::with('client')->where('status', 'pendente')->orderBy('due_at')->take(5)->get(),
        ]);
    }
}
